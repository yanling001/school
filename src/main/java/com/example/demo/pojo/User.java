...
public class User {
    ...
    public User(Integer userId, String nickname, String email, String phone, Date createTime, Date updateTime, String openidWeb, String city, String province, String country, String avatarurl, String openidAnr) {
        this.userId = userId;
